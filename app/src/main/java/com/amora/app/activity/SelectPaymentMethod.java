...
import com.amora.app.databinding.ActivitySelectPaymentMethodBinding;
import com.amora.app.dialog.PaymentCompletedDialog;
...
import com.amora.app.response.PaymentSelector.PaymentSelectorData;
            ...
            public void onPurchasesUpdated(BillingResult billingResult, List<Purchase> purchases) {
                try {
                    ...
                    if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK && purchases != null) {
                        ...
                        Toast.makeText(com.amora.app.activity.SelectPaymentMethod.this, "Payment Cancelled", Toast.LENGTH_SHORT).show();
                    } else {
                        // Handle any other error codes.
                        Toast.makeText(com.amora.app.activity.SelectPaymentMethod.this, "Error occured", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                }
            }
                ...
                new SkuDetailsResponseListener() {
                    ...
                    public void onSkuDetailsResponse(BillingResult billingResult, List<SkuDetails> skuDetailsList) {
                        ...
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK && !skuDetailsList.isEmpty()) {
                            ...
                            int responseCode = billingClient.launchBillingFlow(com.amora.app.activity.SelectPaymentMethod.this
                                    , billingFlowParams).getResponseCode();

                        } else {
                            Toast.makeText(com.amora.app.activity.SelectPaymentMethod.this, "This recharge not available on G-PAY", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
