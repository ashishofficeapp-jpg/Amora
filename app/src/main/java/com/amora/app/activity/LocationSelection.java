        ...
        ((TextView) findViewById(R.id.tv_next)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Intent intent = new Intent(com.amora.app.activity.LocationSelection.this, MainActivity.class);
                    startActivity(intent);
                } catch (Exception e) {
                    Toast.makeText(com.amora.app.activity.LocationSelection.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
